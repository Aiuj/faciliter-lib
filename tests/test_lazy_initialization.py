...
class TestLazyInitialization(unittest.TestCase):
    ...
    def test_cache_imports_no_connection(self):
        ...
        from core_lib.cache import RedisCache, cache_manager
    ...
    def test_llm_imports_no_connection(self):
        ...
        from core_lib.llm import LLMClient, create_llm_client
        from core_lib.llm.llm_config import OpenAIConfig, GeminiConfig
    ...
    def test_llm_client_instantiation_no_connection(self):
        ...
        from core_lib.llm.llm_config import OpenAIConfig, OllamaConfig
    ...
    def test_job_queue_instantiation_no_connection(self):
        ...
        from core_lib.jobs import RedisJobQueue
        from core_lib.jobs.base_job_queue import JobConfig
    ...
    def test_socket_not_called_during_import(self):
        ...
        try:
            ...
            import importlib
            import core_lib.cache
            import core_lib.llm
            import core_lib.embeddings
            
            importlib.reload(core_lib.cache)
